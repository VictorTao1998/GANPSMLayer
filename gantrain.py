    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        for batch_idx, simsample in enumerate(TrainImgLoader):
            ...
            if batch_idx % 50 == 0:
                ...
                image_outputs["errormap"] = [disp_error_image_func.apply(outputs_ori[0], real_gt)]
                ...
                del real_gt
            del realsample, global_step, do_summary, simfeaL, simfeaR, sim_gt, realfeaL, realfeaR, disp_gt_t, original_output
